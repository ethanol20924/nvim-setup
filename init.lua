...
require("lazy").setup({
    ...
    --  The configuration is done below. Search for lspconfig to find it below.
    {
        ...
        dependencies = {
            ...
            "saadparwaiz1/cmp_luasnip", "mstanciu552/cmp-matlab"
        }
...
local servers = {
    ...
    pylsp = {
        pylsp = {
            plugins = {
                pycodestyle = {ignore = {"W291", "E261", "W293"}},
...
local packages = {mypy = {}, ruff = {}, black = {}}
...
require("mason").setup({ensure_installed = vim.tbl_keys(packages)})
...
cmp.setup({
    ...
    sources = {{name = "nvim_lsp"}, {name = "luasnip"}, {name = "cmp_matlab"}}
})
